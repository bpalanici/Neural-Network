...
# train : ~120 - 150 generated 20 0.1 0.1, ~ 100 - 150 normal
# ~100 generated 20 0.2 0.2, then back to normal ~100
...
def define_model():
    ...
    model.add(Conv2D(conv_nr, (1, 1), kernel_initializer=kernel_conv2D,
